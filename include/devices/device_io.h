 ...
 ******************************************************************************
 */
typedef enum MHDeviceState (*mh_device_read_clb_t)(void* handle, char* buffer, const size_t buffer_len, size_t* len);
 ...
 ******************************************************************************
 */
typedef enum MHDeviceState (*mh_device_write_clb_t)(void* handle, const char* buffer, const size_t buffer_len, size_t* len);
 ...
 ******************************************************************************
 */
typedef enum MHDeviceState (*mh_device_signal_clb_t)(void* handle, unsigned int signal);
